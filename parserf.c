            ...
            case KEYWORD:
                if(strcmp(current_token->value, "EXIT") == 0){
                    ...
                    if(current_token->type == END_OF_TOKENS){
                        print_error("Invalid Syntax on Open Parentheses");
                    }
                    if(strcmp(current_token->value, "(") == 0 && current_token->type == SEPARATOR){
                        ...
                        current_token++;
                        if(current_token->type == END_OF_TOKENS){
                            print_error("Invalid Syntax on Integer");
                        }
                        if(current_token->type == INT){
                            ...
                            current_token++;
                            if(current_token->type == END_OF_TOKENS){
                                print_error("Invalid Syntax on Close Parentheses");
                            }
                            if(strcmp(current_token->value, ")") == 0 && current_token->type == SEPARATOR && current_token->type != END_OF_TOKENS){ 
                                ...
                                current_token++;
                                if(current_token->type == END_OF_TOKENS){
                                    print_error("Invalid Syntax on Semicolon\n");
                                }
                                if(strcmp(current_token->value, ";") == 0 && current_token->type == SEPARATOR){
                                    ...
                                    print_error("Invalid Syntax on the Semicolon");
                                }
                            }
                            else{
                                print_error("Invalid Syntax on the Close Parentheses");
                            }
                        }
                        else{
                            print_error("Invalid Syntax on Integer");
